 ...
 */ export function encodeBase64(input, options = {}) {
  ...
  let [output, i] = detach(input, calcSizeBase64(input.length));
 ...
 * );
 * ```
 */ export function encodeIntoBase64(input, output, options = {}) {
  options.alphabet ??= "base64";
  if (typeof input === "string") {
    input = new TextEncoder().encode(input);
  } else if (input instanceof ArrayBuffer) {
  ...
  const min = calcSizeBase64(input.length);
...
//# sourceMappingURL=unstable_base64.js.map