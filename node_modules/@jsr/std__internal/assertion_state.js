 ...
 */ export class AssertionState {
  ...
  constructor(){
    ...
    } else if (// deno-lint-ignore no-explicit-any
    ...
    if (this.#state.assertionCheck || this.#state.assertionCount !== undefined) {
   ...
   */ checkAssertionCountSatisfied() {
    return this.#state.assertionCount !== undefined && this.#state.assertionCount !== this.#state.assertionTriggeredCount;
  }
}
const assertionState = new AssertionState();
/**
...
//# sourceMappingURL=assertion_state.js.map