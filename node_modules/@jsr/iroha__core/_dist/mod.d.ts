 ...
 */ export declare function transactionHash(tx: types.SignedTransaction): crypto.Hash;
export declare function signQuery(payload: types.QueryRequestWithAuthority, privateKey: crypto.PrivateKey): types.SignedQuery;
export declare function signTransaction(payload: types.TransactionPayload, privateKey: crypto.PrivateKey): types.SignedTransaction;
export declare function blockHash(header: types.BlockHeader): crypto.Hash;
