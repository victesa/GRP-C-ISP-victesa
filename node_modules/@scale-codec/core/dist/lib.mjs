...
// tsc-build/core/src/codecs/unit.js
var encodeUnit = encodeFactory(() => {
}, () => 0);
var decodeUnit = () => null;

// tsc-build/core/src/codecs/bool.js
var encodeBool = encodeFactory((value, walker) => {
  walker.u8[walker.idx++] = value ? 1 : 0;
}, () => 1);
var decodeBool = (walker) => walker.u8[walker.idx++] === 1;

// tsc-build/core/src/codecs/int.js
...
function decodeBigIntVarious(walker, bytes, signed) {
  let isNegative = signed && // extracting the most significant bit
  (walker.u8[walker.idx + bytes - 1] & 128) >> 7 === 1;
  let value = 0n;
...
// tsc-build/core/src/codecs/compact.js
var MAX_U8 = 2 ** (8 - 2) - 1;
...
var encodeCompact = (value, walker) => {
  ...
  if (value <= MAX_U16) {
    encodeBigInt((BigInt(value) << 2n) + 1n, "u16", walker);
    return;
  }
  if (value <= MAX_U32) {
    encodeBigInt((BigInt(value) << 2n) + 2n, "u32", walker);
    return;
  }
...
// tsc-build/core/src/codecs/array.js
...
// tsc-build/core/src/codecs/vec.js
...
// tsc-build/core/src/codecs/str.js
...
// tsc-build/core/src/codecs/tuple.js
...
// tsc-build/core/src/codecs/map.js
...
// tsc-build/core/src/codecs/struct.js
...
// tsc-build/core/src/codecs/enum.js
...
function decodeEnum(walker, decoders) {
  ...
  if (decode)
    return variant(tag, decode(walker));
  return variant(tag);
}
...
// tsc-build/core/src/codecs/set.js
...
// tsc-build/core/src/lib.js
import { variant as variant2 } from "@scale-codec/enum";
export {
  EnumEncodeError,
